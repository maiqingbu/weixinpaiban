...
const DIALOG_DEFAULT_DESC_ID = 'dialog-default-description'
...
function DialogContent({
  ...
  const hasDescriptionChild = childArray.some(
    (child) => React.isValidElement(child) && child.type === DialogDescription
  ) || props['aria-describedby'] || props['aria-description']
  ...
  return (
    <DialogPortal>
      ...
      >
        ...
        {children}
        {!hasDescriptionChild && (
          <div id={DIALOG_DEFAULT_DESC_ID} className="sr-only">
            对话框
          </div>
        )}
