...
export const OpenRouterProvider: AIProvider = {
  config: {
    ...
    models: [
      { id: 'anthropic/claude-sonnet-4-6', name: 'Claude Sonnet 4.6（推荐）', license: '商用许可' },
      { id: 'anthropic/claude-opus-4-7', name: 'Claude Opus 4.7', license: '商用许可' },
      { id: 'anthropic/claude-haiku-4-5', name: 'Claude Haiku 4.5（快速）', license: '商用许可' },
      { id: 'google/gemini-2.5-pro', name: 'Gemini 2.5 Pro', license: '商用许可' },
