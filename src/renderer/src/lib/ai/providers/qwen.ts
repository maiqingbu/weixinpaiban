...
export const QwenProvider: AIProvider = {
  config: {
    ...
    models: [
      { id: 'qwen-max', name: 'Qwen3 Max（最强）', license: '商用许可' },
      { id: 'qwen-plus', name: 'Qwen3 Plus（推荐）', license: '商用许可' },
      { id: 'qwen-flash', name: 'Qwen3 Flash（快速）', license: '商用许可' },
      { id: 'qwen-long', name: 'Qwen3 Long（超长 10M）', license: '商用许可' },
      { id: 'qwen3-coder-plus', name: 'Qwen3 Coder Plus', license: '商用许可' },
    ],
    apiBase: 'https://dashscope.aliyuncs.com/compatible-mode/v1',
    docsUrl: 'https://help.aliyun.com/zh/model-studio/get-api-key',
    keyHint: 'sk-...',
    license: '商用许可，详情见阿里云百炼平台服务协议',
    description: '阿里云大模型，Qwen3 系列中文能力出色，生态完善',
  },
